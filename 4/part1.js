...
guards.forEach(g => {
  let sleepSum = g.sleepScore.reduce((a, b) => a + b);
  if (sleepSum > sleepiestSum) {
    sleepiestGuard = g;
  }
});

let sleepiestMinute = sleepiestGuard.sleepScore.indexOf(
  Math.max(...sleepiestGuard.sleepScore)
);
